...
public class SelectYoukeActivity extends Activity implements View.OnClickListener {
    //动作选择 数组
    ...
    private void initView() {
        ...
        for (int i = 3; i < pose_name.length; i+=2) {
            ...
            newPose.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent myIntent = new Intent(SelectYoukeActivity.this, BeforeSportActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_back:
            case R.id.btn_home:
                startActivity(new Intent(SelectYoukeActivity.this,MainYoukeActivity.class));
                SelectYoukeActivity.this.finish();
                break;
            default:
        }
    }
