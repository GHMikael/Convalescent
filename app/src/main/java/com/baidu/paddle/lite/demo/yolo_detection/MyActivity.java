...
public class MyActivity extends Activity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.userImg1:
                ...
                break;
            case R.id.textView:
                Intent i= new Intent(MyActivity.this,DataActivity.class);
                startActivity(i);
                break;
            case R.id.textView2:
                Intent j = new Intent(MyActivity.this,InfoActivity.class);
                startActivity(j);
                break;
        }
    }
    ...
    private void showDialog() {
        MyDialog dialog = new MyDialog(MyActivity.this, R.style.mdialog,
