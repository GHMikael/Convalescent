...
public class MainYoukeActivity extends Activity implements View.OnClickListener,AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceBundle) {
        ...
        setContentView(R.layout.activity_mainyouke);
        initView();
    ...
    private void  initView() {
        mContext = MainYoukeActivity.this;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btn_entry:
                i = new Intent(MainYoukeActivity.this, SelectYoukeActivity.class);
                startActivity(i);
                break;
            case R.id.userImg:
                showDialog();
    ...
    public void logout(){
        ...
        Intent i = new Intent(MainYoukeActivity.this, LoginActivity.class);
        finish();
        startActivity(i);
    }
    ...
    private void showDialog() {
        MyDialog dialog = new MyDialog(MainYoukeActivity.this, R.style.mdialog,
