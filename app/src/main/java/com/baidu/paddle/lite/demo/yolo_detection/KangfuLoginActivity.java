...
public class KangfuLoginActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceBundle) {
        ...
        setContentView(R.layout.activity_kangfulogin);
        initView();
    }

    private void  initView() {

        myToast =new ToastShow(KangfuLoginActivity.this);

        account=findViewById(R.id.account);
        passwd=findViewById(R.id.passwd);

        login_btn = findViewById(R.id.login5); //登录
        ...
        NetClient.getNetClient().callNet(basePath + data, new MyCallBack() {
            ...
            public void onResponse(String json) {
                ...
                if(result.equals("success")){
                    ...
                    Intent i = new Intent(KangfuLoginActivity.this, DoctorActivity.class);
